...
|    21 | ATRDE2ERR | Auto Read 2bit ECC Error  | メモリスクラビング機能の自動読み出しアクセス時に2bit ECC Errorを検出すると本ビットが"1"にセットされます。E2ERRINTビットの割り込みクリアを行うことで、本ビットの状態もクリアされます。 | RO   |
|    20 | AHBE2ERR  | AHB Access 2bit ECC Error | AHBリードアクセス時に2bit ECC Errorを検出すると本ビットが"1"にセットされます。E2ERRINTビットの割り込みクリアを行うことで、本ビットの状態もクリアされます。                            | RO   |
| 19:18 | -         | Reserved                  | Reserved                                                                                                                                                                              | -    |
|    17 | ATRDE1ERR | Auto Read 1bit ECC Error  | メモリスクラビング機能の自動読み出しアクセス時に1bit ECC Errorを検出すると本ビットが"1"にセットされます。E1ERRINTビットの割り込みクリアを行うことで、本ビットの状態もクリアされます。 | RO   |
|    16 | AHBE1ERR  | AHB Access 1bit ECC Error | AHBリードアクセス時に1bit ECC Errorを検出すると本ビットが"1"にセットされます。E1ERRINTビットの割り込みクリアを行うことで、本ビットの状態もクリアされます。                            | RO   |
|  15:9 | -         | Reserved                  | Reserved                                                                                                                                                                              | -    |
|     8 | ECDISINT  | ECC Correct Data Discard  | 1bit ECCエラー検出時のメモリへのライトバック用訂正データの廃棄を検出すると本ビットが"1"にセットされます。                                                                             | R/WC |
|   7:2 | -         | Reserved                  | Reserved                                                                                                                                                                              | -    |
|     1 | E2ERRINT  | 2bit ECC Error            | 2bit ECC Errorを検出すると本ビットが"1"にセットされます。                                                                                                                             | R/WC |
|     0 | E1ERRINT  | 1bit ECC Error            | 1bit ECC Errorを検出すると本ビットが"1"にセットされます。                                                                                                                             | R/WC |
